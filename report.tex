...
Además de esto, se guardan ''Snapshots'' de la simulación en cada evento, para inspección más granular de la simulación, esto no es necesario para la aplicación de este proyecto, pero es útil para depuración y análisis posterior, por defecto esta funcionalidad está desactivada, se puede activar como un parámetro en la fución \texttt{run}, que comienza la simulación. Estos snapshots son objetos que contienen el estado de la simulación en un momento dado.
